            ...
            <Table className="rounded-sm overflow-hidden border border-gray-200 dark:border-gray-700 min-w-full">
                <TableHeader>
                    <TableRow className="bg-gray-50 dark:bg-gray-800">
                        ...
                        <TableHead className="text-xs sm:text-sm">{t("catalog:askingPrice", { defaultValue: "Asking Price" })}</TableHead>
                    ...
                    {catalogData?.length > 0 ? (
                        catalogData.map((item) => (
                            ...
                            >
                                ...
                                <TableCell className="text-xs sm:text-sm text-gray-800 dark:text-gray-200">{item.lotNo}</TableCell>
                                <TableCell className="text-xs sm:text-sm text-gray-800 dark:text-gray-200">{item.category ?? "N/A"}</TableCell>
                                <TableCell className="text-xs sm:text-sm text-gray-800 dark:text-gray-200">{item.grade ?? "N/A"}</TableCell>
                                ...
                                <TableCell className="hidden md:table-cell text-xs sm:text-sm text-gray-800 dark:text-gray-200">{item.sellingMark ?? "N/A"}</TableCell>
                                <TableCell className="hidden md:table-cell text-xs sm:text-sm text-gray-800 dark:text-gray-200">{item.saleCode ?? "N/A"}</TableCell>
                                <TableCell className="text-xs sm:text-sm text-gray-800 dark:text-gray-200">{item.bags}</TableCell>
                                ...
                                <TableCell className="hidden lg:table-cell text-xs sm:text-sm text-gray-800 dark:text-gray-200">{item.producerCountry ?? "N/A"}</TableCell>
                                <TableCell className="text-xs sm:text-sm text-gray-800 dark:text-gray-200">
                                    ${item.askingPrice.toFixed(2)}
                                </TableCell>
                                <TableCell className="hidden lg:table-cell text-xs sm:text-sm text-gray-800 dark:text-gray-200">{item.invoiceNo ?? "N/A"}</TableCell>
                                <TableCell className="hidden lg:table-cell text-xs sm:text-sm text-gray-800 dark:text-gray-200">
                                ...
                                <TableCell className="hidden lg:table-cell text-xs sm:text-sm text-gray-800 dark:text-gray-200">{item.reprint}</TableCell>
                            </TableRow>
                        ))
                    ) : (
                        <TableRow>
                            <TableCell colSpan={15} className="text-center py-4 text-gray-500 dark:text-gray-400 text-xs sm:text-sm">

      ...
      <footer className="border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 sm:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <span aria-label="Facebook" className="hover:text-primary-600">
              <FontAwesomeIcon icon={faFacebook} className="h-6 w-6" />
            </span>
              <span aria-label="Instagram" className="hover:text-primary-600">
              <FontAwesomeIcon icon={faInstagram} className="h-6 w-6" />
            </span>
              <span aria-label="Linkedin" className="hover:text-primary-600">
          ...
          <div className="mt-8 text-center text-sm text-gray-500 flex flex-wrap justify-center gap-4">
            <span>&copy; {currentYear} Black Gold Africa Traders Ltd. All rights reserved.</span>
            <Link
                href="/privacyPolicy"
            ...
            <a
                href="https://dx3b.rcnoc.com:2096/"
                target="_blank"

...
router.post("/export-csv", (0, authMiddleware_1.authMiddleware)(["admin", "user"]), (0, asyncHandler_1.asyncHandler)(sellingPriceController_1.exportSellingPricesCsv));
...
router.get("/:id", (0, asyncHandler_1.asyncHandler)(sellingPriceController_1.getSellingPricesById));
// Create a new selling price
router.post("/", (0, authMiddleware_1.authMiddleware)(["admin"]), (0, asyncHandler_1.asyncHandler)(sellingPriceController_1.createSellingPrices));

...
// Schema for creating a new OutLot
exports.createOutLotSchema = zod_1.z.object({
    ...
    manufactureDate: zod_1.z.string().refine((date) => !isNaN(Date.parse(date)), {
...
exports.querySchema = zod_1.z.object({
    ...
    limit: zod_1.z.coerce.number().int().min(1).max(1000).optional().default(20),
